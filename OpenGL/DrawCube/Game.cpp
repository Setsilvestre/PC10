	...
	while (SDL_PollEvent(&evnt)) {
		...
		case SDL_KEYDOWN:
			...
			case SDLK_DOWN:
				...
				data[1].setPosition(data[1].position.x, data[1].position.y -= 0.01, data[1].position.z);
				data[2].setPosition(data[2].position.x, data[2].position.y -= 0.01, data[2].position.z);
				break;
			case SDLK_UP:
			...
			case SDLK_LEFT:
				...
				data[0].setPosition(data[0].position.x -= 0.01, data[0].position.y, data[0].position.z);
				data[1].setPosition(data[1].position.x -= 0.01, data[1].position.y, data[1].position.z);
				data[2].setPosition(data[2].position.x -= 0.01, data[2].position.y, data[2].position.z);
				break;
			case SDLK_RIGHT:
